...
export type GameQuery = { __typename?: 'Query', game?: { __typename?: 'Game', id: number, name: string, status: GameStatus, owner: number, usersInGame: Array<{ __typename?: 'User', id: number, name: string }> } | null };
